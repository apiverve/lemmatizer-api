...
const (
	baseURL        = "https://api.apiverve.com/v1/lemmatizer"
	defaultTimeout = 30 * time.Second
)

// Client is the Text Lemmatizer API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Text Lemmatizer API client.
...
// Execute makes a request to the Text Lemmatizer API with typed parameters.
//
