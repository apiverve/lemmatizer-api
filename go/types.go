// Package lemmatizer provides a Go client for the Text Lemmatizer API.
//
// For more information, visit: https://apiverve.com/marketplace/lemmatizer?utm_source=go&utm_medium=readme
package lemmatizer
...
// Request contains the parameters for the Text Lemmatizer API.
//
// Parameters:
//   - text (required): string - The text to lemmatize
type Request struct {
...
// ResponseData contains the data returned by the Text Lemmatizer API.
type ResponseData struct {
	Found int `json:"found"`
	Lemmas LemmasData `json:"lemmas"`
}

// LemmasData represents the lemmas object.
type LemmasData struct {
	Cat int `json:"cat"`
	Ran int `json:"ran"`
	Door int `json:"door"`
}
