...
/**
 * Client for the Text Lemmatizer API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/lemmatizer?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/lemmatizer';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\LemmatizerClient] {$message}\n";
        }
    }
}
